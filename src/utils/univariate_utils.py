...
from .common_utils import compute_cost
from .common_utils import dlblue, dlorange, dldarkred, dlmagenta, dlpurple, dlcolors

plt.style.use('../../config/matplotlib_styles/deeplearning.mplstyle')
n_bin = 5
